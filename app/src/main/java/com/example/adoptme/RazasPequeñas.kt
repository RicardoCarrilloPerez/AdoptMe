...
class RazasPequeñas : AppCompatActivity() {
    ...
    private val cardData = mapOf(
        R.id.cardView1 to R.drawable.perrito1,
        R.id.cardView2 to R.drawable.perrito2,
        R.id.cardView3 to R.drawable.perrito3,
        R.id.cardView4 to R.drawable.perrito4
    )

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_razaspequenas)
